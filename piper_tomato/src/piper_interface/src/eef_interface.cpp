...
tl::optional<EefCmdRequest> EefCmdService::convert_srvreq_to_eefreq(const piper_msgs2::CommandEef::Request& srv_req) {
...
bool EefCmdService::on_request(piper_msgs2::CommandEef::Request& req, piper_msgs2::CommandEef::Response& res) {
